# Comparing `tmp/libmata-0.74.0.tar.gz` & `tmp/libmata-0.75.0.tar.gz`
...
### Comparing `libmata-0.74.0/PKG-INFO` & `libmata-0.75.0/PKG-INFO`
...
### Comparing `libmata-0.74.0/libmata.cpp` & `libmata-0.75.0/libmata.cpp`
...
+  if (unlikely(__pyx_assertions_enabled())) {
     __pyx_t_1 = PyObject_RichCompare(__pyx_v_k, __pyx_int_1, Py_GT); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 1552, __pyx_L1_error)
     __pyx_t_2 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely(__pyx_t_2 < 0)) __PYX_ERR(1, 1552, __pyx_L1_error)
...
@@ -34920,15 +34939,15 @@
 ...
 static void __pyx_tp_dealloc_7libmata_Run(PyObject *o) {
...
@@ -35068,15 +35087,15 @@
 ...
 static void __pyx_tp_dealloc_7libmata_Trans(PyObject *o) {
   #if CYTHON_USE_TP_FINALIZE
-  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !_PyGC_FINALIZED(o))) {
+  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !__Pyx_PyObject_GC_IsFinalized(o))) {
     if (PyObject_CallFinalizerFromDealloc(o)) return;
...
@@ -35220,15 +35239,15 @@
 ...
 static void __pyx_tp_dealloc_7libmata_Move(PyObject *o) {
   #if CYTHON_USE_TP_FINALIZE
-  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !_PyGC_FINALIZED(o))) {
+  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !__Pyx_PyObject_GC_IsFinalized(o))) {
     if (PyObject_CallFinalizerFromDealloc(o)) return;
...
@@ -35404,15 +35423,15 @@
 ...
 static void __pyx_tp_dealloc_7libmata_Nfa(PyObject *o) {
   struct __pyx_obj_7libmata_Nfa *p = (struct __pyx_obj_7libmata_Nfa *)o;
   #if CYTHON_USE_TP_FINALIZE
...
+  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && !__Pyx_PyObject_GC_IsFinalized(o)) {
   ...
   (*Py_TYPE(o)->tp_free)(o);
@@ -35651,15 +35670,15 @@
   p = ((struct __pyx_obj_7libmata_Alphabet *)o);
   p->__pyx_vtab = __pyx_vtabptr_7libmata_Alphabet;
   return o;
 }
 
 static void __pyx_tp_dealloc_7libmata_Alphabet(PyObject *o) {
   #if CYTHON_USE_TP_FINALIZE
-  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !_PyGC_FINALIZED(o))) {
+  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !__Pyx_PyObject_GC_IsFinalized(o))) {
     if (PyObject_CallFinalizerFromDealloc(o)) return;
 ...
 static PyMethodDef __pyx_methods_7libmata_Alphabet[] = {
@@ -35754,15 +35773,15 @@
   bad:
   Py_DECREF(o); o = 0;
   return NULL;
 ...
 static void __pyx_tp_dealloc_7libmata_OnTheFlyAlphabet(PyObject *o) {
   #if CYTHON_USE_TP_FINALIZE
-  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !_PyGC_FINALIZED(o))) {
+  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !__Pyx_PyObject_GC_IsFinalized(o))) {
     if (PyObject_CallFinalizerFromDealloc(o)) return;
...
@@ -35871,15 +35890,15 @@
 ...
 static void __pyx_tp_dealloc_7libmata_IntAlphabet(PyObject *o) {
   #if CYTHON_USE_TP_FINALIZE
-  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !_PyGC_FINALIZED(o))) {
+  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !__Pyx_PyObject_GC_IsFinalized(o))) {
     if (PyObject_CallFinalizerFromDealloc(o)) return;
...
@@ -35983,15 +36002,15 @@
 ...
 static void __pyx_tp_dealloc_7libmata_BinaryRelation(PyObject *o) {
   #if CYTHON_USE_TP_FINALIZE
-  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !_PyGC_FINALIZED(o))) {
+  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !__Pyx_PyObject_GC_IsFinalized(o))) {
     if (PyObject_CallFinalizerFromDealloc(o)) return;
...
@@ -36109,15 +36128,15 @@
 ...
 static void __pyx_tp_dealloc_7libmata_Segmentation(PyObject *o) {
   #if CYTHON_USE_TP_FINALIZE
-  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !_PyGC_FINALIZED(o))) {
+  if (unlikely(PyType_HasFeature(Py_TYPE(o), Py_TPFLAGS_HAVE_FINALIZE) && Py_TYPE(o)->tp_finalize) && (!PyType_IS_GC(Py_TYPE(o)) || !__Pyx_PyObject_GC_IsFinalized(o))) {
     if (PyObject_CallFinalizerFromDealloc(o)) return;
...
### Comparing `libmata-0.74.0/libmata.pxd` & `libmata-0.75.0/libmata.pxd`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/libmata.pyx` & `libmata-0.75.0/libmata.pyx`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/args.hxx` & `libmata-0.75.0/mata/3rdparty/args.hxx`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/catch.hpp` & `libmata-0.75.0/mata/3rdparty/catch.hpp`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/catch.hpp.1.9.3` & `libmata-0.75.0/mata/3rdparty/catch.hpp.1.9.3`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/catch.hpp.2.0.1` & `libmata-0.75.0/mata/3rdparty/catch.hpp.2.0.1`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/catch.hpp.2.13.9` & `libmata-0.75.0/mata/3rdparty/catch.hpp.2.13.9`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/Doxyfile.in` & `libmata-0.75.0/mata/3rdparty/cudd/Doxyfile.in`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/LICENSE` & `libmata-0.75.0/mata/3rdparty/cudd/LICENSE`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/README` & `libmata-0.75.0/mata/3rdparty/cudd/README`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/RELEASE.NOTES` & `libmata-0.75.0/mata/3rdparty/cudd/RELEASE.NOTES`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cplusplus/cuddObj.cc` & `libmata-0.75.0/mata/3rdparty/cudd/cplusplus/cuddObj.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cplusplus/test_obj.test.in` & `libmata-0.75.0/mata/3rdparty/cudd/cplusplus/test_obj.test.in`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cplusplus/testmulti.cc` & `libmata-0.75.0/mata/3rdparty/cudd/cplusplus/testmulti.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cplusplus/testobj.cc` & `libmata-0.75.0/mata/3rdparty/cudd/cplusplus/testobj.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddAPI.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddAPI.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddAddAbs.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddAddAbs.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddAddApply.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddAddApply.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddAddFind.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddAddFind.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddAddInv.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddAddInv.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddAddIte.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddAddIte.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddAddNeg.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddAddNeg.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddAddWalsh.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddAddWalsh.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddAndAbs.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddAndAbs.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddAnneal.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddAnneal.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddApa.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddApa.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddApprox.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddApprox.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddBddAbs.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddBddAbs.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddBddCorr.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddBddCorr.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddBddIte.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddBddIte.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddBridge.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddBridge.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddCache.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddCache.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddCheck.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddCheck.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddClip.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddClip.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddCof.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddCof.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddCompose.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddCompose.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddDecomp.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddDecomp.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddEssent.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddEssent.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddExact.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddExact.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddExport.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddExport.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddGenCof.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddGenCof.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddGenetic.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddGenetic.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddGroup.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddGroup.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddHarwell.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddHarwell.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddInit.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddInit.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddInt.h` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddInt.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddInteract.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddInteract.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddLCache.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddLCache.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddLevelQ.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddLevelQ.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddLinear.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddLinear.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddLiteral.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddLiteral.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddMatMult.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddMatMult.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddPriority.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddPriority.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddRead.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddRead.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddRef.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddRef.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddReorder.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddReorder.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddSat.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddSat.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddSign.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddSign.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddSolve.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddSolve.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddSplit.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddSplit.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddSubsetHB.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddSubsetHB.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddSubsetSP.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddSubsetSP.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddSymmetry.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddSymmetry.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddTable.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddTable.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddUtil.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddUtil.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddWindow.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddWindow.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddZddCount.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddZddCount.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddZddFuncs.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddZddFuncs.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddZddGroup.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddZddGroup.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddZddIsop.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddZddIsop.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddZddLin.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddZddLin.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddZddMisc.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddZddMisc.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddZddPort.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddZddPort.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddZddReord.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddZddReord.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddZddSetop.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddZddSetop.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddZddSymm.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddZddSymm.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/cuddZddUtil.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/cuddZddUtil.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/test_cudd.test.in` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/test_cudd.test.in`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/testcudd.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/testcudd.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd/testextra.c` & `libmata-0.75.0/mata/3rdparty/cudd/cudd/testextra.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/cudd_config.h.in` & `libmata-0.75.0/mata/3rdparty/cudd/cudd_config.h.in`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/README.dddmp` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/README.dddmp`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/README.testdddmp` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/README.testdddmp`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/RELEASE_NOTES` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/RELEASE_NOTES`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmp.h` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmp.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmpBinary.c` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmpBinary.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmpConvert.c` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmpConvert.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmpDbg.c` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmpDbg.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmpInt.h` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmpInt.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmpLoad.c` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmpLoad.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmpLoadCnf.c` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmpLoadCnf.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmpNodeAdd.c` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmpNodeAdd.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmpNodeBdd.c` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmpNodeBdd.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmpNodeCnf.c` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmpNodeCnf.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmpStoreAdd.c` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmpStoreAdd.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmpStoreBdd.c` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmpStoreBdd.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmpStoreCnf.c` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmpStoreCnf.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmpStoreMisc.c` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmpStoreMisc.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/dddmpUtil.c` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/dddmpUtil.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/doc/dddmp-2.0-A4.ps` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/doc/dddmp-2.0-A4.ps`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/doc/dddmp-2.0-Letter.ps` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/doc/dddmp-2.0-Letter.ps`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/doc/dddmpAllAbs.html` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/doc/dddmpAllAbs.html`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/doc/dddmpAllDet.html` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/doc/dddmpAllDet.html`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/doc/dddmpAllFile.html` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/doc/dddmpAllFile.html`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/doc/dddmpDesc.html` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/doc/dddmpDesc.html`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/doc/dddmpExtAbs.html` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/doc/dddmpExtAbs.html`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/doc/dddmpExtDet.html` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/doc/dddmpExtDet.html`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/0or1.bdd` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/0or1.bdd`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/1.add` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/1.add`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/1.bdd` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/1.bdd`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/2.bdd` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/2.bdd`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/2and3.bdd` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/2and3.bdd`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/3.bdd` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/3.bdd`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/4.bdd` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/4.bdd`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/4.bdd.bis1` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/4.bdd.bis1`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/4.bdd.bis2` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/4.bdd.bis2`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/4.bdd.bis3` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/4.bdd.bis3`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/4.bdd.bis4` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/4.bdd.bis4`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/4.cnf` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/4.cnf`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/4.cnf.bis` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/4.cnf.bis`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/4.max1` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/4.max1`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/4.max2` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/4.max2`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/4bis.bdd` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/4bis.bdd`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/exp/4xor5.bdd` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/exp/4xor5.bdd`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/dddmp/testdddmp.c` & `libmata-0.75.0/mata/3rdparty/cudd/dddmp/testdddmp.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/doc/cudd.tex.in` & `libmata-0.75.0/mata/3rdparty/cudd/doc/cudd.tex.in`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/doc/phase.pdf` & `libmata-0.75.0/mata/3rdparty/cudd/doc/phase.pdf`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/epd/epd.c` & `libmata-0.75.0/mata/3rdparty/cudd/epd/epd.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/epd/epd.h` & `libmata-0.75.0/mata/3rdparty/cudd/epd/epd.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/epd/epdInt.h` & `libmata-0.75.0/mata/3rdparty/cudd/epd/epdInt.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/groups.dox` & `libmata-0.75.0/mata/3rdparty/cudd/groups.dox`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/include/mata/cudd/cudd.h` & `libmata-0.75.0/mata/3rdparty/cudd/include/mata/cudd/cudd.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/include/mata/cudd/cuddObj.hh` & `libmata-0.75.0/mata/3rdparty/cudd/include/mata/cudd/cuddObj.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/mtr/mtr.h` & `libmata-0.75.0/mata/3rdparty/cudd/mtr/mtr.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/mtr/mtrBasic.c` & `libmata-0.75.0/mata/3rdparty/cudd/mtr/mtrBasic.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/mtr/mtrGroup.c` & `libmata-0.75.0/mata/3rdparty/cudd/mtr/mtrGroup.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/mtr/mtrInt.h` & `libmata-0.75.0/mata/3rdparty/cudd/mtr/mtrInt.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/mtr/test_mtr.test.in` & `libmata-0.75.0/mata/3rdparty/cudd/mtr/test_mtr.test.in`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/mtr/testmtr.c` & `libmata-0.75.0/mata/3rdparty/cudd/mtr/testmtr.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/st/st.c` & `libmata-0.75.0/mata/3rdparty/cudd/st/st.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/st/st.h` & `libmata-0.75.0/mata/3rdparty/cudd/st/st.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/st/testst.c` & `libmata-0.75.0/mata/3rdparty/cudd/st/testst.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/util/cpu_stats.c` & `libmata-0.75.0/mata/3rdparty/cudd/util/cpu_stats.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/util/cpu_time.c` & `libmata-0.75.0/mata/3rdparty/cudd/util/cpu_time.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/util/cstringstream.c` & `libmata-0.75.0/mata/3rdparty/cudd/util/cstringstream.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/util/cstringstream.h` & `libmata-0.75.0/mata/3rdparty/cudd/util/cstringstream.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/util/datalimit.c` & `libmata-0.75.0/mata/3rdparty/cudd/util/datalimit.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/util/pathsearch.c` & `libmata-0.75.0/mata/3rdparty/cudd/util/pathsearch.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/util/pipefork.c` & `libmata-0.75.0/mata/3rdparty/cudd/util/pipefork.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/util/prtime.c` & `libmata-0.75.0/mata/3rdparty/cudd/util/prtime.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/util/safe_mem.c` & `libmata-0.75.0/mata/3rdparty/cudd/util/safe_mem.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/util/strsav.c` & `libmata-0.75.0/mata/3rdparty/cudd/util/strsav.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/util/texpand.c` & `libmata-0.75.0/mata/3rdparty/cudd/util/texpand.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/util/ucbqsort.c` & `libmata-0.75.0/mata/3rdparty/cudd/util/ucbqsort.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd/util/util.h` & `libmata-0.75.0/mata/3rdparty/cudd/util/util.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/bnet.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/bnet.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/bnet.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/bnet.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/chkMterm.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/chkMterm.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/config.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/config.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cpu_stats.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cpu_stats.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cpu_time.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cpu_time.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cstringstream.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cstringstream.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cstringstream.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/cstringstream.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cudd.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/cudd.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddAPI.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddAPI.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddAddAbs.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddAddAbs.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddAddApply.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddAddApply.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddAddFind.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddAddFind.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddAddInv.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddAddInv.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddAddIte.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddAddIte.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddAddNeg.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddAddNeg.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddAddWalsh.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddAddWalsh.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddAndAbs.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddAndAbs.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddAnneal.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddAnneal.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddApa.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddApa.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddApprox.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddApprox.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddBddAbs.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddBddAbs.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddBddCorr.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddBddCorr.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddBddIte.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddBddIte.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddBridge.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddBridge.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddCache.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddCache.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddCheck.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddCheck.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddClip.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddClip.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddCof.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddCof.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddCompose.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddCompose.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddDecomp.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddDecomp.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddEssent.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddEssent.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddExact.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddExact.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddExport.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddExport.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddGenCof.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddGenCof.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddGenetic.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddGenetic.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddGroup.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddGroup.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddHarwell.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddHarwell.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddInit.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddInit.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddInt.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddInt.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddInteract.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddInteract.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddLCache.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddLCache.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddLevelQ.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddLevelQ.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddLinear.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddLinear.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddLiteral.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddLiteral.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddMatMult.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddMatMult.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddObj.cc` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddObj.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddObj.hh` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddObj.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddPriority.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddPriority.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddRead.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddRead.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddRef.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddRef.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddReorder.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddReorder.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddSat.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddSat.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddSign.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddSign.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddSolve.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddSolve.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddSplit.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddSplit.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddSubsetHB.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddSubsetHB.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddSubsetSP.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddSubsetSP.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddSymmetry.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddSymmetry.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddTable.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddTable.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddUtil.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddUtil.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddWindow.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddWindow.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddZddCount.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddZddCount.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddZddFuncs.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddZddFuncs.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddZddGroup.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddZddGroup.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddZddIsop.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddZddIsop.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddZddLin.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddZddLin.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddZddMisc.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddZddMisc.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddZddPort.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddZddPort.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddZddReord.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddZddReord.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddZddSetop.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddZddSetop.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddZddSymm.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddZddSymm.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/cuddZddUtil.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/cuddZddUtil.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/datalimit.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/datalimit.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmp.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmp.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmpBinary.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmpBinary.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmpConvert.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmpConvert.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmpDbg.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmpDbg.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmpInt.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmpInt.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmpLoad.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmpLoad.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmpLoadCnf.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmpLoadCnf.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmpNodeAdd.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmpNodeAdd.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmpNodeBdd.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmpNodeBdd.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmpNodeCnf.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmpNodeCnf.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmpStoreAdd.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmpStoreAdd.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmpStoreBdd.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmpStoreBdd.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmpStoreCnf.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmpStoreCnf.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmpStoreMisc.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmpStoreMisc.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/dddmpUtil.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/dddmpUtil.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/epd.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/epd.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/epd.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/epd.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/epdInt.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/epdInt.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/include/mata/cudd/cudd.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/include/mata/cudd/cudd.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/include/mata/cudd/cuddObj.hh` & `libmata-0.75.0/mata/3rdparty/cudd-min/include/mata/cudd/cuddObj.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/main.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/main.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/mtr.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/mtr.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/mtrBasic.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/mtrBasic.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/mtrGroup.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/mtrGroup.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/mtrInt.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/mtrInt.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/ntr.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/ntr.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/ntr.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/ntr.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/ntrBddTest.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/ntrBddTest.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/ntrHeap.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/ntrHeap.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/ntrMflow.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/ntrMflow.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/ntrShort.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/ntrShort.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/ntrZddTest.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/ntrZddTest.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/pathsearch.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/pathsearch.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/pipefork.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/pipefork.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/prtime.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/prtime.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/safe_mem.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/safe_mem.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/st.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/st.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/st.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/st.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/strsav.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/strsav.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/testcudd.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/testcudd.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/testdddmp.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/testdddmp.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/testextra.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/testextra.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/testmtr.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/testmtr.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/testmulti.cc` & `libmata-0.75.0/mata/3rdparty/cudd-min/testmulti.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/testobj.cc` & `libmata-0.75.0/mata/3rdparty/cudd-min/testobj.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/testst.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/testst.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/texpand.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/texpand.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/ucbqsort.c` & `libmata-0.75.0/mata/3rdparty/cudd-min/ucbqsort.c`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/cudd-min/util.h` & `libmata-0.75.0/mata/3rdparty/cudd-min/util.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/CONTRIBUTORS` & `libmata-0.75.0/mata/3rdparty/re2/CONTRIBUTORS`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/LICENSE` & `libmata-0.75.0/mata/3rdparty/re2/LICENSE`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/bitmap256.h` & `libmata-0.75.0/mata/3rdparty/re2/re2/bitmap256.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/compile.cc` & `libmata-0.75.0/mata/3rdparty/re2/re2/compile.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/parse.cc` & `libmata-0.75.0/mata/3rdparty/re2/re2/parse.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/perl_groups.cc` & `libmata-0.75.0/mata/3rdparty/re2/re2/perl_groups.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/pod_array.h` & `libmata-0.75.0/mata/3rdparty/re2/re2/pod_array.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/prog.cc` & `libmata-0.75.0/mata/3rdparty/re2/re2/prog.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/prog.h` & `libmata-0.75.0/mata/3rdparty/re2/re2/prog.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/re2.cc` & `libmata-0.75.0/mata/3rdparty/re2/re2/re2.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/re2.h` & `libmata-0.75.0/mata/3rdparty/re2/re2/re2.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/regexp.cc` & `libmata-0.75.0/mata/3rdparty/re2/re2/regexp.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/regexp.h` & `libmata-0.75.0/mata/3rdparty/re2/re2/regexp.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/simplify.cc` & `libmata-0.75.0/mata/3rdparty/re2/re2/simplify.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/sparse_array.h` & `libmata-0.75.0/mata/3rdparty/re2/re2/sparse_array.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/sparse_set.h` & `libmata-0.75.0/mata/3rdparty/re2/re2/sparse_set.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/stringpiece.cc` & `libmata-0.75.0/mata/3rdparty/re2/re2/stringpiece.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/stringpiece.h` & `libmata-0.75.0/mata/3rdparty/re2/re2/stringpiece.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/tostring.cc` & `libmata-0.75.0/mata/3rdparty/re2/re2/tostring.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/unicode_casefold.cc` & `libmata-0.75.0/mata/3rdparty/re2/re2/unicode_casefold.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/unicode_casefold.h` & `libmata-0.75.0/mata/3rdparty/re2/re2/unicode_casefold.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/unicode_groups.cc` & `libmata-0.75.0/mata/3rdparty/re2/re2/unicode_groups.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/unicode_groups.h` & `libmata-0.75.0/mata/3rdparty/re2/re2/unicode_groups.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/re2/walker-inl.h` & `libmata-0.75.0/mata/3rdparty/re2/re2/walker-inl.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/util/logging.h` & `libmata-0.75.0/mata/3rdparty/re2/util/logging.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/util/mutex.h` & `libmata-0.75.0/mata/3rdparty/re2/util/mutex.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/util/rune.cc` & `libmata-0.75.0/mata/3rdparty/re2/util/rune.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/util/strutil.cc` & `libmata-0.75.0/mata/3rdparty/re2/util/strutil.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/util/utf.h` & `libmata-0.75.0/mata/3rdparty/re2/util/utf.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/re2/util/util.h` & `libmata-0.75.0/mata/3rdparty/re2/util/util.h`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/simlib/include/mata/simlib/explicit_lts.hh` & `libmata-0.75.0/mata/3rdparty/simlib/include/mata/simlib/explicit_lts.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/simlib/include/mata/simlib/util/abstract_transl.hh` & `libmata-0.75.0/mata/3rdparty/simlib/include/mata/simlib/util/abstract_transl.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/simlib/include/mata/simlib/util/binary_relation.hh` & `libmata-0.75.0/mata/3rdparty/simlib/include/mata/simlib/util/binary_relation.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/simlib/include/mata/simlib/util/caching_allocator.hh` & `libmata-0.75.0/mata/3rdparty/simlib/include/mata/simlib/util/caching_allocator.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/simlib/include/mata/simlib/util/convert.hh` & `libmata-0.75.0/mata/3rdparty/simlib/include/mata/simlib/util/convert.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/simlib/include/mata/simlib/util/shared_counter.hh` & `libmata-0.75.0/mata/3rdparty/simlib/include/mata/simlib/util/shared_counter.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/simlib/include/mata/simlib/util/shared_list.hh` & `libmata-0.75.0/mata/3rdparty/simlib/include/mata/simlib/util/shared_list.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/simlib/include/mata/simlib/util/simlib.hh` & `libmata-0.75.0/mata/3rdparty/simlib/include/mata/simlib/util/simlib.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/simlib/include/mata/simlib/util/smart_set.hh` & `libmata-0.75.0/mata/3rdparty/simlib/include/mata/simlib/util/smart_set.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/simlib/include/mata/simlib/util/splitting_relation.hh` & `libmata-0.75.0/mata/3rdparty/simlib/include/mata/simlib/util/splitting_relation.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/simlib/include/mata/simlib/util/transl_weak.hh` & `libmata-0.75.0/mata/3rdparty/simlib/include/mata/simlib/util/transl_weak.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/simlib/include/mata/simlib/util/two_way_dict.hh` & `libmata-0.75.0/mata/3rdparty/simlib/include/mata/simlib/util/two_way_dict.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/3rdparty/simlib/src/explicit_lts_sim.cc` & `libmata-0.75.0/mata/3rdparty/simlib/src/explicit_lts_sim.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/LICENSE` & `libmata-0.75.0/mata/LICENSE`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/README.md` & `libmata-0.75.0/mata/README.md`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/afa.hh` & `libmata-0.75.0/mata/include/mata/afa.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/alphabet.hh` & `libmata-0.75.0/mata/include/mata/alphabet.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/closed-set.hh` & `libmata-0.75.0/mata/include/mata/closed-set.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/inter-aut.hh` & `libmata-0.75.0/mata/include/mata/inter-aut.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/mintermization.hh` & `libmata-0.75.0/mata/include/mata/mintermization.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/nfa-algorithms.hh` & `libmata-0.75.0/mata/include/mata/nfa-algorithms.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/nfa-plumbing.hh` & `libmata-0.75.0/mata/include/mata/nfa-plumbing.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/nfa-strings.hh` & `libmata-0.75.0/mata/include/mata/nfa-strings.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/nfa.hh` & `libmata-0.75.0/mata/include/mata/nfa.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/number-predicate.hh` & `libmata-0.75.0/mata/include/mata/number-predicate.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/ord-vector.hh` & `libmata-0.75.0/mata/include/mata/ord-vector.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/parser.hh` & `libmata-0.75.0/mata/include/mata/parser.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/re2parser.hh` & `libmata-0.75.0/mata/include/mata/re2parser.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/sparse-set.hh` & `libmata-0.75.0/mata/include/mata/sparse-set.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/synchronized-iterator.hh` & `libmata-0.75.0/mata/include/mata/synchronized-iterator.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/include/mata/util.hh` & `libmata-0.75.0/mata/include/mata/util.hh`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/src/afa/afa.cc` & `libmata-0.75.0/mata/src/afa/afa.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/src/alphabet.cc` & `libmata-0.75.0/mata/src/alphabet.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/src/inter-aut.cc` & `libmata-0.75.0/mata/src/inter-aut.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/src/mintermization.cc` & `libmata-0.75.0/mata/src/mintermization.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/src/nfa/nfa-complement.cc` & `libmata-0.75.0/mata/src/nfa/nfa-complement.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/src/nfa/nfa-concatenation.cc` & `libmata-0.75.0/mata/src/nfa/nfa-concatenation.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/src/nfa/nfa-inclusion.cc` & `libmata-0.75.0/mata/src/nfa/nfa-inclusion.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/src/nfa/nfa-intersection.cc` & `libmata-0.75.0/mata/src/nfa/nfa-intersection.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/src/nfa/nfa-universal.cc` & `libmata-0.75.0/mata/src/nfa/nfa-universal.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/src/nfa/nfa.cc` & `libmata-0.75.0/mata/src/nfa/nfa.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/src/parser.cc` & `libmata-0.75.0/mata/src/parser.cc`
...
### Comparing `libmata-0.74.0/mata/src/re2parser.cc` & `libmata-0.75.0/mata/src/re2parser.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/src/strings/nfa-noodlification.cc` & `libmata-0.75.0/mata/src/strings/nfa-noodlification.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/src/strings/nfa-segmentation.cc` & `libmata-0.75.0/mata/src/strings/nfa-segmentation.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/mata/src/strings/nfa-strings.cc` & `libmata-0.75.0/mata/src/strings/nfa-strings.cc`

 * *Files identical despite different names*

### Comparing `libmata-0.74.0/setup.py` & `libmata-0.75.0/setup.py`
