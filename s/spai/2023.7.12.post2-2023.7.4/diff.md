# Comparing `tmp/spai-2023.7.12.post2.tar.gz` & `tmp/spai-2023.7.4.tar.gz`
...
### Comparing `spai-2023.7.12.post2/spai/cli/src/usecases/run/local.py` & `spai-2023.7.4/spai/cli/src/usecases/run/local.py`
