# Comparing `tmp/nginx-ldap-auth-service-2.0.0.tar.gz` & `tmp/nginx-ldap-auth-service-2.0.1.tar.gz`
...
### Comparing `nginx-ldap-auth-service-2.0.0/LICENSE.txt` & `nginx-ldap-auth-service-2.0.1/LICENSE.txt`
