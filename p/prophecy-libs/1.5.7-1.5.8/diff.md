# Comparing `tmp/prophecy-libs-1.5.7.tar.gz` & `tmp/prophecy-libs-1.5.8.tar.gz`
...
### Comparing `prophecy-libs-1.5.7/prophecy/streaming/delta_lake_utils.py` & `prophecy-libs-1.5.8/prophecy/streaming/delta_lake_utils.py`
