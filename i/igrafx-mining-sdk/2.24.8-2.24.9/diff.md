# Comparing `tmp/igrafx_mining_sdk-2.24.8.tar.gz` & `tmp/igrafx_mining_sdk-2.24.9.tar.gz`
...
### Comparing `igrafx_mining_sdk-2.24.8/pyproject.toml` & `igrafx_mining_sdk-2.24.9/pyproject.toml`
