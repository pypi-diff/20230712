# Comparing `tmp/efel-4.2.7.tar.gz` & `tmp/efel-4.3.0.tar.gz`
...
### Comparing `efel-4.2.7/COPYING` & `efel-4.3.0/COPYING`
...
### Comparing `efel-4.2.7/efel.egg-info/SOURCES.txt` & `efel-4.3.0/efel.egg-info/SOURCES.txt`
