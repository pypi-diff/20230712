# Comparing `tmp/ergondata-executions-0.0.7.tar.gz` & `tmp/ergondata-executions-0.0.8.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "ergondata-executions-0.0.7.tar", last modified: Mon Mar 27 18:37:26 2023, max compression
+gzip compressed data, was "ergondata-executions-0.0.8.tar", last modified: Wed Jul 12 19:37:07 2023, max compression
```

## Comparing `ergondata-executions-0.0.7.tar` & `ergondata-executions-0.0.8.tar`

### file list

```diff
@@ -1,13 +1,13 @@
-drwxr-xr-x   0 daniel     (502) staff       (20)        0 2023-03-27 18:37:26.703600 ergondata-executions-0.0.7/
--rw-r--r--   0 daniel     (502) staff       (20)      308 2023-03-27 18:37:26.703278 ergondata-executions-0.0.7/PKG-INFO
-drwxr-xr-x   0 daniel     (502) staff       (20)        0 2023-03-27 18:37:26.697221 ergondata-executions-0.0.7/ergondata_executions/
--rw-r--r--   0 daniel     (502) staff       (20)       65 2023-03-24 20:47:01.000000 ergondata-executions-0.0.7/ergondata_executions/__init__.py
--rw-r--r--   0 daniel     (502) staff       (20)     7078 2023-03-27 18:37:00.000000 ergondata-executions-0.0.7/ergondata_executions/executions.py
-drwxr-xr-x   0 daniel     (502) staff       (20)        0 2023-03-27 18:37:26.702721 ergondata-executions-0.0.7/ergondata_executions.egg-info/
--rw-r--r--   0 daniel     (502) staff       (20)      308 2023-03-27 18:37:26.000000 ergondata-executions-0.0.7/ergondata_executions.egg-info/PKG-INFO
--rw-r--r--   0 daniel     (502) staff       (20)      295 2023-03-27 18:37:26.000000 ergondata-executions-0.0.7/ergondata_executions.egg-info/SOURCES.txt
--rw-r--r--   0 daniel     (502) staff       (20)        1 2023-03-27 18:37:26.000000 ergondata-executions-0.0.7/ergondata_executions.egg-info/dependency_links.txt
--rw-r--r--   0 daniel     (502) staff       (20)       27 2023-03-27 18:37:26.000000 ergondata-executions-0.0.7/ergondata_executions.egg-info/requires.txt
--rw-r--r--   0 daniel     (502) staff       (20)       21 2023-03-27 18:37:26.000000 ergondata-executions-0.0.7/ergondata_executions.egg-info/top_level.txt
--rw-r--r--   0 daniel     (502) staff       (20)       38 2023-03-27 18:37:26.703685 ergondata-executions-0.0.7/setup.cfg
--rw-r--r--   0 daniel     (502) staff       (20)      430 2023-03-27 17:56:26.000000 ergondata-executions-0.0.7/setup.py
...
### Comparing `ergondata-executions-0.0.7/ergondata_executions/executions.py` & `ergondata-executions-0.0.8/ergondata_executions/executions.py`
